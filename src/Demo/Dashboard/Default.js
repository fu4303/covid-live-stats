...
//Api Client
import {fetchGlobalStats} from '../../service/api';
...
/*    setData = (stateVariable, data, country) =>{
        let responseTransform = {
            ...data,
            country
        }
        this.setState({globalStats:responseTransform});
    }*/

    getApiStatsData = () => {
        fetchGlobalStats()
            .then(response => this.setState({globalStats: response.data}))
    };
    ...
    render() {
       /* const tabContent = (
        ...
        const {globalStats:{confirmed,deaths, recovered, lastUpdate}} = this.state;
                    ...
                    <Col md={6} xl={4}>
                        <Card className='card-social'>
                            <Card.Body className='border-bottom'>
                                <div className="row align-items-center justify-content-center">
                                    <div className="col-auto">
                                        <i className="fa fa-globe text-c-red f-36" aria-hidden="true"></i>
                                    </div>
                                    <div className="col text-right">
                                        <h3>{confirmed ? this.numberFormat(confirmed.value):'0'}</h3>
                                        <h5 className="text-c-green mb-0"><span className="text-muted">Total Covid-19 Cases:</span></h5>
                                    </div>
                                </div>
                            </Card.Body>
                            <Card.Body>
                                <div className="row align-items-center justify-content-center card-active">
                                    <div className="col-6">
                                        <h6 className="text-center m-b-10"><span className="text-muted m-r-5">Deaths:</span>{deaths ? this.numberFormat(deaths.value):'0'}</h6>
                                        <div className="progress">
                                            <div className="progress-bar progress-deaths-theme" role="progressbar" style={{width: '100%', height: '6px'}} aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"/>
                                        </div>
                                    </div>
                                    <div className="col-6">
                                        <h6 className="text-center  m-b-10"><span className="text-muted m-r-5">Recovered:</span>{recovered ? this.numberFormat(recovered.value):'0'}</h6>
                                        <div className="progress">
                                            <div className="progress-bar progress-recovered-theme" role="progressbar" style={{width: '100%', height: '6px'}} aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"/>
                                        </div>
                                    </div>
                                </div>
                            </Card.Body>
              ...
              {/*      <Col md={6} xl={8} className='m-b-30'>
                ...
                <Row>
                    ...
                    <Col md={12} lg={12} xl={12}>
                        <Card className='Recent-Users'>
                            <Card.Header>
                                <Card.Title as='h5'>Covid 19 Cases By Country</Card.Title>
                            </Card.Header>
                            <Card.Body className='px-0 py-2'>
                            <GlobalStatsGrid/>
                            </Card.Body>
